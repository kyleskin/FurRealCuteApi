...
public partial class PetService
{
    ...
    private static void ValidateAgainstStoragePetOnModify(Pet inputPet, Pet storagePet)
    {
        switch (inputPet)
        {
            ...
            case { } when inputPet.CreatedBy != storagePet.CreatedBy:
                throw new InvalidPetException(
                    parameterName: nameof(inputPet.CreatedBy),
                    parameterValue: inputPet.CreatedBy);
            
            case { } when inputPet.UpdatedDate == storagePet.UpdatedDate:
                throw new InvalidPetException(
                    parameterName: nameof(inputPet.UpdatedDate),
